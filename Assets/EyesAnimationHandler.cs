...
namespace Mikk.Avatar.Expression
{
    ...
    public class EyesAnimationHandler : MonoBehaviour
    {
        ...
        public void UpdateHeadMesh()
        {
            ...
            // headMesh = gameObject.transform.GetChild(0).Find("Head_Mesh").gameObject.GetMeshRenderer(MeshType.HeadMesh, true);

            headMesh = gameObject.transform.GetChild(0).Find("Head_Mesh").GetComponent<SkinnedMeshRenderer>();
